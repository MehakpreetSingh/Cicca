...
import {data , chainIcons} from './constant'
    ...
    <>
        <div className='container'>
            ...
            <div className='belowText'>
                Bitindi is a fast, high-throughput open-source smart contract platform for digital assets and Dapps.
            </div>
            ...
            <div className='compareFrame'>
                <div className='ellipse_corner'>
                    <div className='bar2'><div className='bar1'></div></div>
                        ...
                        <div className='featureList'>
                            {
                                Object.keys(data).map((el) => {
                                    return <div className='listItems'>{el}</div>
                                })
                            }
                        </div>
                    </div>
                    <div className='products'>
                        {Object.keys(data[Object.keys(data)[0]]).map((el) => {
                            return <div className='productCol'>
                                {!(el === "Cicca") ? <div className='productLogo'>
                                <SVG src={chainIcons[el]} title={el} />
                                </div> :
                                ...
                                <div className='productInfo'>
                                {
                                    Object.keys(data).map((key) => {
                                        return <div className='details'>{data[key][el]}</div>
                                    })
                                }
                            </div></div>
                        })}
